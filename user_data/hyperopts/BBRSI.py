...
class BBRSIHyperopt(IHyperOpt):
    ...
    def indicator_space() -> List[Dimension]:
        ...
        """
        return [
            Integer(5, 50 , name='buy-rsi-value'),
            Categorical([True, False], name='buy-rsi-enabled'),
            Categorical(['buy_tr_bb_lower_1sd', 'buy_tr_bb_lower_2sd', 'buy_tr_bb_lower_3sd', 'buy_tr_bb_lower_4sd'], name='buy-trigger')
        ]
    ...
    def buy_strategy_generator(params: Dict[str, Any]) -> Callable:
        ...
        def populate_buy_trend(dataframe: DataFrame, metadata: dict) -> DataFrame:
            ...
            if params.get('buy-rsi-enabled'):
                conditions.append(dataframe['rsi-buy'] > params['buy-rsi-value'])

            # TRIGGERS
            if 'buy-trigger' in params:
                if params['buy-trigger'] == 'buy_tr_bb_lower_1sd':
                    conditions.append(dataframe['close'] < dataframe['bb_lowerband_1sd'])
                if params['buy-trigger'] == 'buy_tr_bb_lower_2sd':
                    conditions.append(dataframe['close'] < dataframe['bb_lowerband_2sd'])
                if params['buy-trigger'] == 'buy_tr_bb_lower_3sd':
                    conditions.append(dataframe['close'] < dataframe['bb_lowerband_3sd'])
                if params['buy-trigger'] == 'buy_tr_bb_lower_4sd':
    ...
    def sell_indicator_space() -> List[Dimension]:
        ...
        return [
            ...
            Categorical(['sell_tr_bb_upper_1sd', 'sell_tr_bb_upper_2sd', 'sell_tr_bb_upper_3sd', 'sell_tr_bb_upper_4sd',
                        'sell_tr_bb_middle_1sd', 'sell_tr_bb_middle_2sd', 'sell_tr_bb_middle_3sd', 'sell_tr_bb_middle_4sd'            
            ], name='sell-trigger')
        ]
    ...
    def sell_strategy_generator(params: Dict[str, Any]) -> Callable:
        ...
        def populate_sell_trend(dataframe: DataFrame, metadata: dict) -> DataFrame:
            ...
            if 'sell-trigger' in params:
                ...
                if params['sell-trigger'] == 'sell_tr_bb_upper_2sd':
                    conditions.append(dataframe['close'] > dataframe['bb_upperband_2sd'])
                if params['sell-trigger'] == 'sell_tr_bb_upper_3sd':
                    conditions.append(dataframe['close'] > dataframe['bb_upperband_3sd'])
                if params['sell-trigger'] == 'sell_tr_bb_upper_4sd':
                    conditions.append(dataframe['close'] > dataframe['bb_upperband_4sd'])
                if params['sell-trigger'] == 'sell_tr_bb_middle_1sd':
                    conditions.append(dataframe['close'] > dataframe['bb_middleband_1sd'])
                if params['sell-trigger'] == 'sell_tr_bb_middle_2sd':
                    conditions.append(dataframe['close'] > dataframe['bb_middleband_2sd'])
                if params['sell-trigger'] == 'sell_tr_bb_middle_3sd':
                    conditions.append(dataframe['close'] > dataframe['bb_middleband_3sd'])
                if params['sell-trigger'] == 'sell_tr_bb_middle_4sd':
                    conditions.append(dataframe['close'] > dataframe['bb_middleband_4sd'])
